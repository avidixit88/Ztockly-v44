...
split_long_short = st.sidebar.toggle(
    ...
    value=False,
    help="If enabled, you can require a higher score for shorts (or vice versa)."
)
long_threshold = st.sidebar.slider("LONG score threshold", 50, 99, int(score_threshold), 1)
short_threshold = st.sidebar.slider("SHORT score threshold", 50, 99, int(score_threshold), 1)
